...
`);
    ...
    async webhook(body, res) {
        ...
        const { payload } = body;
        const { id, order_id, amount, method, bank, acquirer_data, error_reason, card, card_id, wallet, } = payload.payment.entity;
        ...
        try {
            ...
            if (isSeamless) {
                ...
                const collect_request = await this.databaseService.CollectRequestModel.findOneAndUpdate({
                    _id: collectIdObject,
                }, {
                    $set: {
                        gateway: collect_request_schema_1.Gateway.EDVIRON_RAZORPAY_SEAMLESS,
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], RazorpayNonseamlessController.prototype, "handleCallbackGet", null);
__decorate([
