...
let WorldlineController = class WorldlineController {
    ...
    async worldlinePayment(req, res) {
        try {
            ...
            if (!request.worldline_merchant_id || !request.worldline_token)
                throw new common_1.NotFoundException('Order not found');
            ...
            $(document).ready(function () {
              ...
              var reqJson = {
                ...
                consumerData: {
                  ...
                  paymentMode: "all",
                  merchantId: "${request.worldline_merchant_id}",
                  currency: "INR",
                  txnId: "${request._id}",
                  items: [{
                    itemId: "first",
    ...
    async handleCallbackPost(req, res) {
        ...
        const decryptMessage = await this.worldlineService.decryptAES256Hex(msg, collectRequest.worldline_encryption_key, collectRequest.worldline_encryption_iV);
