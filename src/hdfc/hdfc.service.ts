...
export class HdfcService implements GatewayService {
    ...
    async checkStatus(collectRequestId: String): Promise<{ status: TransactionStatus, amount: number, paymentInstrument?: string | null, paymentInstrumentBank?: string | null }> {
