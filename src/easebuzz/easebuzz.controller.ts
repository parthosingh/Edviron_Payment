...
export class EasebuzzController {
  ...
  @Post('/non-seamless/callback')
  async handleEasebuzzNonSeamlessCallbackPost(
    @Body() body: any,
    @Req() req: any,
    @Res() res: any,
  ) {
  ...
  @Get('/non-seamless/callback')
  async handleEasebuzzNonSeamlessCallback(
    @Body() body: any,
    @Req() req: any,
    @Res() res: any,
  ) {
